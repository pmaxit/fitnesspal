...
class _DashboardData {
  static const greeting = 'Hi Maya';
  static const dateSummary = 'Wednesday, May 14 • 72°F • Mostly Sunny';
  static const wellnessScore = 84;
  static const aiInsight =
      'Your recovery is improving after better sleep consistency.';
  static const ctaLabel = "Today's Plan";
  static const aiChipLabel = 'AI Coach';
  static const metricCards = [
    _MetricCardData(
      label: 'Calories',
      value: '1,840',
      unit: 'kcal',
        ...
        child: SingleChildScrollView(
          child: Column(
            ...
            children: [
              ...
              Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Second row: date/weather summary
                    Text(
                      _DashboardData.dateSummary,
                      style: Theme.of(context).textTheme.bodyMedium,
                    ),
                    const SizedBox(height: 16),
                    // Third row: AI Coach chip
                    GestureDetector(
                      onTap: () {},
                      child: Container(
              ...
              Padding(
                padding: const EdgeInsets.symmetric(horizontal: 20),
                child: _HeroWellnessCard(isDarkMode: isDark),
              ),
                  ...
                  children: [
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: _MetricCard(
                            data: _DashboardData.metricCards[0],
                            isDarkMode: isDark,
                          ),
                        ),
                        ...
                        Expanded(
                          child: _MetricCard(
                            data: _DashboardData.metricCards[1],
                            isDarkMode: isDark,
                          ),
                        ),
                      ],
                    ...
                    Row(
                      children: [
                        Expanded(
                          child: _MetricCard(
                            data: _DashboardData.metricCards[2],
                            isDarkMode: isDark,
                          ),
                        ),
                        const SizedBox(width: 12),
                        Expanded(
                          child: _MetricCard(
                            data: _DashboardData.metricCards[3],
                            isDarkMode: isDark,
                          ),
                        ),
                      ],
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Row(
                            children: [
                              Icon(Icons.auto_awesome, size: 12, color: _emeraldGradientEnd),
                              const SizedBox(width: 4),
                              Container(
                                padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 2),
                                decoration: BoxDecoration(
                                  border: Border.all(
                                    color: _emeraldGradientEnd.withValues(alpha: 0.5),
                                  ),
...
class _HeroWellnessCard extends StatelessWidget {
  ...
  const _HeroWellnessCard({required this.isDarkMode});
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      // Wellness score ring
                      _WellnessScoreRing(isDarkMode: isDark),
                      const Spacer(),
...
class _WellnessScoreRing extends StatelessWidget {
  ...
  const _WellnessScoreRing({required this.isDarkMode});
  ...
  Widget build(BuildContext context) {
    return ProgressRing(
      ...
      percentage: _DashboardData.wellnessScore.toDouble(),
      label: 'Wellness Score',
      value: _DashboardData.wellnessScore.toString(),
      unit: '',
      centerWidget: Text(
        _DashboardData.wellnessScore.toString(),
        style: TextStyle(
          fontSize: 42,
...
class _MetricCard extends StatelessWidget {
  ...
  const _MetricCard({required this.data, required this.isDarkMode});

  Color _trendColor() {
    if (data.trend.startsWith('↑')) return Colors.green;
    if (data.trend.startsWith('↓')) return Colors.red;
  ...
  Widget build(BuildContext context) {
    return Container(
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: isDarkMode ? AppColors.darkShadowSm : AppColors.lightShadowSm,
            blurRadius: 12,
