        ...
        child: Column(
          ...
          children: [
              ...
              child: Column(
                ...
                children: [
                  ...
                  Row(
                    ...
                    children: [
                      Text('8.2 / 10', style: Theme.of(context).textTheme.displayMedium),
                      Container(
            ...
            Padding(
              ...
              child: Column(
                children: [
                  _timelineItem(context, '06:30', 'Sleep ended', 'Quality: 85%', isDark, Colors.purple),
                  _timelineItem(context, '07:15', 'Morning run', '3.2 km, 18 min', isDark, Colors.green),
                  _timelineItem(context, '09:00', 'Breakfast', 'Logged: 450 cal', isDark, Colors.orange),
                  _timelineItem(context, '12:30', 'Lunch', 'Logged: 620 cal', isDark, Colors.orange),
                  _timelineItem(context, '15:45', 'Supplements', 'Vitamin D, Omega-3', isDark, Colors.blue),
                  _timelineItem(context, '18:00', 'Evening walk', '1.2 km', isDark, Colors.green),
                ],
              ),
            ),
